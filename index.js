...
function loadCourses() {
    fetch("https://exam-api-courses.std-900.ist.mospolytech.ru/api/courses?api_key=f97f0ebd-977c-4c9b-833e-8310102212a4")
        .then(res => res.json())
        .then(data => {
            allCourses = data;
            renderCoursesPage(1);
...
function loadTutors() {
    fetch("https://exam-api-courses.std-900.ist.mospolytech.ru/api/tutors?api_key=f97f0ebd-977c-4c9b-833e-8310102212a4")
        .then(res => res.json())
        .then(data => {
            allTutors = data;
            renderTutorsPage(1);
